 ...
 *
 */
public class EnableAxisTrackingTask extends ParallelTaskImpl {
	 ...
	 * @param enableRot
	 */
	public EnableAxisTrackingTask(String name, TaskManager manager, boolean enableAzm, boolean enableAlt, boolean enableRot) {
		super(name, manager);
	...
	public void onInit() {
		super.onInit();
		taskLog.log(2, "Enabling axis tracking for: "+
				(enableAzm ? "AZM ": "")+
				(enableAlt ? "ALT ": "")+
				(enableRot ? "ROT": ""));
	}
	...
	public void onSubTaskFailed(Task task) {	
		...
		if (((Default_TaskImpl)task).getRunCount() < 2) {
			...
			failed(err.getErrorCode(), "Axis track enable failure");		
		}
	}
