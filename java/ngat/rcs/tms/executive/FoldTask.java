...
/** A leaf Task for performing a Telescope Fold move. An appropriate FOCUS 
 * command is generated and sent to the telescope control system.
 *
 * <dl>
 * <dt><b>RCS:</b>
 * <dd>$Id: FoldTask.java,v 1.1 2006/12/12 08:28:27 snf Exp $
 * <dt><b>Source:</b>
 * <dd>$Source: /home/dev/src/rcs/java/ngat/rcs/tmm/executive/RCS/FoldTask.java,v $
 * </dl>
 * @author $Author: snf $
 * @version $Revision: 1.1 $
 */
public class FoldTask extends Default_TaskImpl {
    
    public static final String CLASS = "FoldTask";

    /** Constant denoting the typical expected time for this Task to complete.*/
    public static final long DEFAULT_TIMEOUT = 120000L;

    /** The fold to move to (mm).*/
    protected int pos;

    /** Create a Fold task to move to specifed position.
     * If the subsystem resource (TelescopeControlSystem) cannot be found ???.
     * @param fold The fold demand.
     * should be based on the COMMAND_ID.
     * @param manager The Task's manager.
     */
    public FoldTask(String name,
		    TaskManager manager,
		    int pos) {
	...
	// -------------------------------
	MOVE_FOLD foldMove = new MOVE_FOLD(name, pos);
	...
	logger.log(1, CLASS, name, "onInit",
		   "Starting Fold move to position: "+pos);
    }
